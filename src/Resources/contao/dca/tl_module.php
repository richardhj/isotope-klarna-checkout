...
$GLOBALS['TL_DCA']['tl_module']['palettes']['iso_klarna_checkout'] = '{title_legend},name,headline,type;'
                                                                     ...
                                                                     .'{redirect_legend},iso_cart_jumpTo,klarna_terms_page,klarna_cancellation_terms_page,klarna_checkout_page,klarna_confirmation_page,klarna_cancellation_page;'
...
$GLOBALS['TL_DCA']['tl_module']['fields']['klarna_cancellation_terms_page'] = [
    'label' => &$GLOBALS['TL_LANG']['tl_module']['klarna_cancellation_terms_page'],
    'exclude' => true,
    'inputType' => 'pageTree',
    'foreignKey' => 'tl_page.title',
    'eval' => [
